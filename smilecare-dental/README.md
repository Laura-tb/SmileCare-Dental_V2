...
## 2. Tecnologías utilizadas en V1
...
## MODIFICACIONES V2.
20.02.2026- v2 → Migración completa a Angular 21 (Standalone, Signals, etc.)

Se ha realizado la migración completa de la aplicación web de gestión de citas desarrollada originalmente en HTML, CSS y JavaScript Vanilla hacia una arquitectura basada en Angular 21 (standalone + signals).
...
- Separación clara entre `core`, `shared`, `pages` y `layouts`

### Layout principal

Se creó un `MainLayout` que incluye: Header, RouterOutlet y Footer.

## Gestión de estado moderna

Se emplea Angular Signals
...
- Migrado a **Reactive Forms**
- Validaciones con `Validators`
- FormBuilder `nonNullable`
- Gestión de submit declarativa

### Tabla dinámica

- Renderizada con signals

## Servicio de dominio

Se implementó: core/services/citas.service.ts  para desacoplar la lógica del componente.
